...
{
    [Test, AutoData]
    public void Constructor_TransformsCommandToEntity(Guid id, ApprenticeAccounts.Application.Commands.CreateMyApprenticeCommand.CreateMyApprenticeshipCommand command)
    {
